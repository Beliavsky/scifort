...
Test reference data in `test/gamma_reference.f90` and
`test/beta_reference.f90` is generated by `tools/generate_gamma_reference.py`
and `tools/generate_beta_reference.py` with mpmath, which is BSD licensed;
